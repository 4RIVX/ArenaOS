...
export const getGenerateOrganizerSummaryUrl = () => {




  return `/api/gemini/organizer/summary`
}

/**
 * @summary Generate AI operational summary from mock metrics
 */
export const generateOrganizerSummary = async (organizerSummaryInput: OrganizerSummaryInput, options?: RequestInit): Promise<OrganizerSummaryOutput> => {

  return customFetch<OrganizerSummaryOutput>(getGenerateOrganizerSummaryUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(organizerSummaryInput)
  }
);}
...
export const getGenerateOrganizerSummaryMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateOrganizerSummary>>, TError,{data: BodyType<OrganizerSummaryInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof generateOrganizerSummary>>, TError,{data: BodyType<OrganizerSummaryInput>}, TContext> => {

const mutationKey = ['generateOrganizerSummary'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof generateOrganizerSummary>>, {data: BodyType<OrganizerSummaryInput>}> = (props) => {
          const {data} = props ?? {};

          return  generateOrganizerSummary(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GenerateOrganizerSummaryMutationResult = NonNullable<Awaited<ReturnType<typeof generateOrganizerSummary>>>
    export type GenerateOrganizerSummaryMutationBody = BodyType<OrganizerSummaryInput>
    export type GenerateOrganizerSummaryMutationError = ErrorType<unknown>

    /**
 * @summary Generate AI operational summary from mock metrics
 */
export const useGenerateOrganizerSummary = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateOrganizerSummary>>, TError,{data: BodyType<OrganizerSummaryInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof generateOrganizerSummary>>,
        TError,
        {data: BodyType<OrganizerSummaryInput>},
        TContext
      > => {
      return useMutation(getGenerateOrganizerSummaryMutationOptions(options));
    }

export const getGenerateAnnouncementUrl = () => {




  return `/api/gemini/organizer/announcement`
}

/**
 * @summary Generate a professional stadium announcement
 */
export const generateAnnouncement = async (announcementInput: AnnouncementInput, options?: RequestInit): Promise<AnnouncementOutput> => {

  return customFetch<AnnouncementOutput>(getGenerateAnnouncementUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getGenerateAnnouncementMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateAnnouncement>>, TError,{data: BodyType<AnnouncementInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof generateAnnouncement>>, TError,{data: BodyType<AnnouncementInput>}, TContext> => {

const mutationKey = ['generateAnnouncement'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof generateAnnouncement>>, {data: BodyType<AnnouncementInput>}> = (props) => {
          const {data} = props ?? {};

          return  generateAnnouncement(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GenerateAnnouncementMutationResult = NonNullable<Awaited<ReturnType<typeof generateAnnouncement>>>
    export type GenerateAnnouncementMutationBody = BodyType<AnnouncementInput>
    export type GenerateAnnouncementMutationError = ErrorType<unknown>

    /**
 * @summary Generate a professional stadium announcement
 */
export const useGenerateAnnouncement = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof generateAnnouncement>>, TError,{data: BodyType<AnnouncementInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof generateAnnouncement>>,
        TError,

...
export const SendGeminiMessageBody = zod.object({
  "content": zod.string(),
  "arenaRole": zod.string().optional(),
  "arenaFeature": zod.string().optional(),
 ...
 */
export const GenerateOrganizerSummaryBody = zod.object({
  "metrics": zod.record(zod.string(), zod.unknown()).optional()
})

export const GenerateOrganizerSummaryResponse = zod.object({
  "summary": zod.string(),
